...
export const SOCIAL_LINKS = {
  ...
  whatsapp: 'https://api.whatsapp.com/send/?phone=48572232501&text&type=phone_number&app_absent=0',
  calendly: 'https://calendly.com/paulkochuiev/30min?duration=30&back=1&month=2025-12',
};
...
export const SECTIONS = {
  about: {
    title: 'About',
    description: 'Software Engineer specializing in React, TypeScript, and Next.js. I have worked on e-commerce, admin panels, SaaS, and video editing applications, delivering scalable and high-performance web solutions.',
    expertise: {
      label: 'Expertise in:',
    ...
    closing: 'Passionate about building clean and maintainable UI with a strong focus on usability, accessibility, and performance. Always learning and staying updated with the latest front-end trends.',
  },
  contact: {
    title: 'Reach Me',
    buttons: {
